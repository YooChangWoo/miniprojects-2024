...
namespace SmartHomeMonitoringApp.Logics
{
    public class Commons
    {
        ...
        // localhost, 1277.0.0.1, 192.168.5.4
        public static string BROKERHOST { get; set; } = "192.168.5.4"; //Window Mqtt Broker Mosquitto IP
        public static string MOTTTOPIC { get; set; } = "pknu/data/";  // 대소문자구분, 마지막 /도 중요!!
